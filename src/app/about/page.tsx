...
export default function AboutPage() {
  return (
    <div className="min-h-screen bg-brand-charcoal">
      {/* Hero */}
      <div className="relative bg-brand-charcoal border-b border-brand-mid/30 py-16 sm:py-24 overflow-hidden">
        ...
        <div className="relative container-padded text-center">
          <p className="text-brand-gold text-xs uppercase tracking-widest mb-3">Our Story</p>
          <h1 className="font-serif text-3xl sm:text-5xl font-bold text-brand-white mb-4">
      ...
      <section className="py-16 container-padded">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            <h2 className="font-serif text-2xl sm:text-3xl font-bold text-brand-white mb-4">
        ...
        <div className="container-padded">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {VALUES.map(({ icon: Icon, title, desc }) => (
              <div key={title} className="bg-brand-dark rounded-xl p-5 border border-brand-mid/20 text-center">
                ...
                <h3 className="text-brand-white font-semibold text-sm mb-2">{title}</h3>
