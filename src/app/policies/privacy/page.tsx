      ...
      <div className="container-padded max-w-4xl space-y-8">
        <div>
          <nav className="text-xs text-brand-muted mb-4 flex gap-2" aria-label="breadcrumb">
            ...
            <span>/</span>
            <span className="text-brand-light">Privacy Policy</span>
          </nav>
        ...
        <div className="bg-brand-charcoal rounded-xl p-6 sm:p-8 border border-brand-mid/20 space-y-6 text-brand-light text-sm leading-relaxed">
          <section className="space-y-3">
            <h2 className="font-serif text-lg font-bold text-brand-white">1. Information We Collect</h2>
          ...
          <section className="space-y-3">
            <h2 className="font-serif text-lg font-bold text-brand-white">2. How We Use Your Data</h2>
            <p className="text-brand-muted">
          ...
          <section className="space-y-3">
            <h2 className="font-serif text-lg font-bold text-brand-white">3. Third-Party Services & Couriers</h2>
            <p className="text-brand-muted">
          ...
          <section className="space-y-3">
            <h2 className="font-serif text-lg font-bold text-brand-white">4. Contact Us Regarding Your Data</h2>
            <p className="text-brand-muted">
              If you wish to update or delete your profile information from our database, please message us at <span className="text-brand-gold">lillyumfragrance@gmail.com</span> or via WhatsApp at <span className="text-brand-gold">0752369613</span>.
            </p>
          </section>
        </div>
      </div>
