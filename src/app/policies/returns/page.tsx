      ...
      <div className="container-padded max-w-4xl space-y-8">
        <div>
          <nav className="text-xs text-brand-mid mb-4 flex gap-2" aria-label="breadcrumb">
            ...
            <span>/</span>
            <span className="text-brand-charcoal font-medium">Return Policy</span>
          </nav>
        ...
        <div className="bg-brand-white rounded-3xl p-6 sm:p-8 border border-brand-light shadow-card space-y-6 text-brand-charcoal text-sm leading-relaxed">
          <section className="space-y-3">
            ...
            <p className="text-brand-mid">
              Due to the hygiene and personal care nature of luxury perfumes, we can only accept returns or provide replacements under the following strict conditions within <strong className="text-brand-charcoal">48 hours of delivery</strong>:
            </p>
